...
`,u=e=>{let t=Number(e),n=5-Number(e);return`
    ${c.repeat(t)}
    ${l.repeat(n)}
  `},d=()=>`
  ...
  `,p=()=>{let e=location.pathname.startsWith(`/front_7th_chapter2-1/product`);return`
...
`,h=({loading:e,product:t,relatedProducts:n})=>m({children:e?g:y({product:t,relatedProducts:n})}),g=`
...
`,C=({loading:e,products:t=[],total:n})=>`
<!-- 상품 목록 -->
    <div class="mb-6">
      <div>
        ${e?`
    ...
    </div>`,w=({filters:e={search:``},categories:t={}})=>`
        <!-- 검색 및 필터 -->
